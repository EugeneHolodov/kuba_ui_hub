...
import '../widgets/kuba_search_bar_with_nav_tabs.dart';
import '../models/activity_item.dart';
import '../data/activity_data.dart';

class NavBarTabsNavigationBarPage extends StatefulWidget {
  const NavBarTabsNavigationBarPage({super.key});

  @override
  State<NavBarTabsNavigationBarPage> createState() =>
      _NavBarTabsNavigationBarPageState();
}

class _NavBarTabsNavigationBarPageState
    extends State<NavBarTabsNavigationBarPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('Nav Bar Tabs - Material 3 NavigationBar'),
        centerTitle: true,
      ),
      body: Column(
        children: [
      ...
      bottomNavigationBar: KubaSearchBarWithNavTabs(

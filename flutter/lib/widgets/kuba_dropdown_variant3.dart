...
class KubaDropdownVariant3 extends StatefulWidget {
  final String? value;
  ...
  @override
  State<KubaDropdownVariant3> createState() => _KubaDropdownVariant3State();
}

class _KubaDropdownVariant3State extends State<KubaDropdownVariant3>
    ...
    return Row(
      ...
      children: [
        ...
        AnimatedSize(
          ...
          child: hasValue
              ? Row(
                  children: [const SizedBox(width: 8), _buildStatusIcon(true)],
                )

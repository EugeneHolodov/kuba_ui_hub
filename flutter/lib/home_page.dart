...
import 'ui/dialog_menu_page.dart';
              ...
              child: InkWell(
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => const DialogMenuPage(),
                    ),
                  );
                },
                borderRadius: BorderRadius.circular(16),
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            const SizedBox(height: 4),
                            Text(
                              'Material 3 dialogs with brand styling',
                              style: Theme.of(context).textTheme.bodySmall,
                            ),
                          ],
                        ),
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            const SizedBox(height: 4),
                            Text(
                              'Draw signature with canvas and preview',
                              style: Theme.of(context).textTheme.bodySmall,
                            ),
                          ],
                        ),
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            const SizedBox(height: 4),
                            Text(
                              'Material 3 switch with title and subtitle',
                              style: Theme.of(context).textTheme.bodySmall,
                            ),
                          ],
                        ),
            ...
            Card(
              ...
              child: InkWell(
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => const ToggleMenuPage()),
                  );
                },
                borderRadius: BorderRadius.circular(16),
                child: Padding(
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            const SizedBox(height: 4),
                            Text(
                              'Two-option toggle for selecting one choice',
                              style: Theme.of(context).textTheme.bodySmall,
                            ),
                          ],
                        ),
              ...
              child: InkWell(
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => const FeatureListCardMenuPage(),
                    ),
                  );
                },
                borderRadius: BorderRadius.circular(16),
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            const SizedBox(height: 4),
                            Text(
                              'Big card with chart on left and tabs on right',
                              style: Theme.of(context).textTheme.bodySmall,
                            ),
                          ],
                        ),
